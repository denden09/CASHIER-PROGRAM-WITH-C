...
#define MAX_ACCOUNT_ID_LENGTH			20					// Maksimal karakter untuk ID kasir
#define MIN_ACCOUNT_PASSWORD_LENGTH		5					// Minimal karakter untuk password kasir
#define MAX_ACCOUNT_PASSWORD_LENGTH		20					// Maksimal karakter untuk password kasir
#define MIN_ACCOUNT_NAME_LENGTH			5					// Minimal karakter untuk nama kasir
#define MAX_ACCOUNT_NAME_LENGTH			20					// Maksimal karakter untuk nama kasir

#define MAX_ITEM_CODE_LENGTH			11					// Maksimal digit untuk kode barang
#define MAX_ITEM_NAME_LENGTH			20					// Maksimal karakter untuk nama barang
